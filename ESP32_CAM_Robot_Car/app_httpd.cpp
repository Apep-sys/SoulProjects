...
<html>
    <head>
        ...
        <title>ESP32 CAM Drilling Machine</title>
        <style>
    body {
    ...
    .button7 {background-color: #b82741; width: 100px;} // Full red
    .button8 {background-color: #b82741; width: 100px;} // Crimson

    
    button:hover {
        background: #ff494d; # Red colour for hovering over a button
    }
    button:active {
        background: #f21c21; # Brighter red for pressing the button
    }
    button.disabled {
        cursor: default;
        background: #a0a0a0;  # Gray colour for disabled buttons
    }
    input[type="range"] {
    ...
    .switch {       # The box around the sloder
        display: block;
        position: relative;
        line-height: 22px;
        font-size: 16px;
    ...
    .switch input {   # Hiding the basic HTML checkbox
        outline: 0;
        opacity: 0;
        width: 0;
        height: 0;
    ...
    .slider,
    .slider:before {      # Moving the slider
        display: inline-block;
        transition: 0.4s;
    }
    .slider:before {
    ...
    <br/>
          ...
          <section id="buttons">
                ...
                <div id="controls" class="control-container">
                  ...
                  <tr><td></td><td align="center"><button class="button button2" id="forward" onclick="fetch(document.location.origin+'/control?var=car&val=1');">UP</button></td><td></td></tr>
                  <tr><td></td><td align="right"><button class="button button7" id="standby" onclick="fetch(document.location.origin+'/control?var=car&val=7');">STANDBY</button></td><td></td></tr>
                  <tr><td align="center"><button class="button button2" id="turnleft" onclick="fetch(document.location.origin+'/control?var=car&val=2');">COUNTER-CLOCKWISE</button></td><td align="center"></td><td align="center"><button class="button button2" id="turnright" onclick="fetch(document.location.origin+'/control?var=car&val=4');">CLOCKWISE</button></td></tr><td align="center"></td><td align="center"><button class="button button8" id="turnright" onclick="fetch(document.location.origin+'/control?var=car&val=8');">STOP DRILL</button></td></tr>
                  <tr><td></td><td align="center"><button class="button button2" id="backward" onclick="fetch(document.location.origin+'/control?var=car&val=5');">DOWN</button></td><td></td></tr>
                  ...
                  <tr><td align="right">Speed: 0 </td><td align="center" colspan="2"><input type="range" id="speed" min="0" max="255" value="200" onchange="try{fetch(document.location.origin+'/control?var=speed&val='+this.value);}catch(e){}"></td><td align="center">255</td><td>  </td></tr>
